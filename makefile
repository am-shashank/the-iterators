...
all: 	dchat.o leader.o client.o
	g++ $(CPPFLAGS) -o dchat dchat.o leader.o utils.o client.o queue.o message.o clientQueue.o
dchat.o: dchat.cpp
...
id.o:id.cpp utils.h globals.h
	g++ $(CPPFLAGS) -c id.cpp
clean:
	rm -f dchat dchat.o leader.o client.o utils.o queue.o message.o clientQueue.o chatRoomUser.o id.o
